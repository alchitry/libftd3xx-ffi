    ...
    fn test_ft_getlibraryversion() {
        ...
        cfg_if::cfg_if! {
            if #[cfg(all(target_os = "linux", target_arch = "x86_64"))] {
                // for some reason 1.1.0 reports as 0x1000015
                let expected_version = 0x1_00_00_15;
            } else if #[cfg(all(target_os = "linux", target_arch = "x86"))] {
                // version "1.0.5" is represented as 0x010005
                let expected_version = 0x01_00_05;
            } else if #[cfg(all(target_os = "windows", target_arch = "x86_64"))] {
                // version "1.4.0.1" is represented as 0x1040001
                let expected_version = 0x1_04_00_01;
        ...
        println!("libftd3xx version: {version}");
